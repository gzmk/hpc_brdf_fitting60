...
writetable(T,'/scratch/gk925/hpc_brdf_fitting60/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/hpc_brdf_fitting60');
...
imPath = ['/scratch/gk925/hpc_brdf_fitting60/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
